    ...
    <section className="content__section">
      ...
      <div className={styles["about-section-container"]}>
        <p className={styles["section__paragraph"]}>
          ...
          our own families. Whether you're sharing a meal with friends, honoring
          a special occasion, or simply looking for a taste of home, we invite
          you to sit back, relax, and enjoy a true Albanian dining experience.
        </p>
